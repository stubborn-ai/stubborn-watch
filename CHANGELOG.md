...
- Coordinated program release **0.10.0b2**; core floor `stubborn-stub>=0.10.0b2`.
...
- `stubborn-watch` now expects `stubborn-stub>=0.10.0b2`, matching the unified core release line.
...
[0.10.0b2]: https://github.com/stubborn-ai/stubborn-watch/compare/v0.10.0b1...v0.10.0b2
